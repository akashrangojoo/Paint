package edu.niu.cs.z1778702.fingerpaint;
...
public class MainActivity extends Activity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout printLayout = (LinearLayout)findViewById(R.id.colors);

        currentColor = (ImageButton)printLayout.getChildAt(0);
        ...
        drawBtn = (Button)findViewById(R.id.eraseButton);
        drawBtn.setOnClickListener(this);

        drawBtn = (Button)findViewById(R.id.newButton);
        drawBtn.setOnClickListener(this);

        drawBtn = (Button)findViewById(R.id.saveButton);
        drawBtn.setOnClickListener(this);
    }//end of onCreate

    //onClick method for all of the buttons to make them interactive
    ...
    public void onClick(View v) {
        ...
        //handle erase button
            ...
            eraseDialog.show();
            /*LinearLayout printLayout = (LinearLayout)findViewById(R.id.colors);
            currentColor = (ImageButton)printLayout.getChildAt(1);
            drawingView.setPaintColor(currentColor.getTag().toString());*/
